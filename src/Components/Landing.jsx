  ...
  return (
    <>
      <div className='h-[100vh] w-full bg-[rgb(120,216,222)] flex flex-col items-center py-32'>
            ...
            <h2 className='text-3xl mt-7'>ابني عاداتك الصحية</h2>
            <p className='mt-4 text-lg'>بدل ما تعتمد علي الارادة بس !! خليك مدمن للعادات الصحية .</p>
            <Link to='/signup'><button className='bg-[#0a5d89] w-96 h-12 mt-5 text-white rounded-md text-xl'>ابدأي دلوقتي</button></Link>
